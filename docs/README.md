...
1. [`architecture.md`](architecture.md) — module boundaries, data flow, and interface separation.
2. [`reasoning.md`](reasoning.md) — knowledge representation, inference rules, reasoning trace, and simulation flow.
